...
<div class="col-sm-12 col-md-3 col-xl-3">
       <div class="bg-light rounded p-4">
        ...
        <form action="add-cate-material" class="d-flex mb-2" onsubmit="return confirm('Are you sure you want to add this category?')">
                ...
                <div class="d-flex align-items-center border-bottom py-2">
                    ...
                    <div class="w-100 ms-3">
                        <div class="d-flex w-100 align-items-center justify-content-between">
                            <form onsubmit="return confirm('Are you sure you want to update this category?')" action="update-material-category" id="updateCate_${category.cateID}" style="display: flex; justify-content: space-between; align-items: center; gap: 10px">
                            ...
                            <form action="change-status-category-material" id="changeStatusCate_${category.cateID}" class="form-check form-switch">
