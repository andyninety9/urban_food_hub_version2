...
<c:forEach var="plan" items="${mealWeekPlan}">
    <c:if test="${plan.cateID == 'CTM000123'}">
        ...
        <a href="add-personal-plan?mealPlanID=${plan.mealPlanID}&accID=${user.accID}" style="background-color: #4ACD8E; color: white; border: none; padding: 10px 30px" type="button" class="btn btn-secondary">Add to personal plans</a>
    </div>
